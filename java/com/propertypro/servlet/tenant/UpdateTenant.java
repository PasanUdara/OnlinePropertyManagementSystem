	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if (isTrue) {
	    	String alertMessage = "Insert successful";
        	 ...
        	 response.getWriter().println("<script> alert('" + alertMessage + "'); window.location.href='GetAllTenantServlet?userId="+user+"' </script>"); // Changed from forward to redirect to avoid duplicate submissions
	    } else {
