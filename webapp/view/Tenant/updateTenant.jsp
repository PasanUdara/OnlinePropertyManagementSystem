        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                <div class="form-container">
                    <h1 class="section-title">Update Tenant</h1>
                    
                    <!-- Hidden ID field for update -->
                    <form id="tenantForm" method="post" action="../../UpdateTenant" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="property" name="property" value="<%=property%>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <label for="startDate" class="form-label">Lease Start Date</label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <label for="endDate" class="form-label">Lease End Date</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                            ...
                            <div class="col-12 mt-4">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <a href="DisplayAllTenants" class="btn btn-outline-secondary me-md-2">
