  ...
  <header>
    <div class="container nav-container">
      ...
      <div class="nav-links">
        ...
        <a href="../../ListServ" class="nav-link">Property</a>
        <a href="#" class="nav-link">Pricing</a>
      </div>
      
      <div class="auth-buttons">
        <a href="../property/login.jsp" class="btn btn-login">Log Out</a>
    ...
    <div class="container">
      ...
      <section class="property-section">
        <div class="section-header">
          ...
          <a href="../../ListServ" class="view-all">VIEW ALL</a>
        </div>
      ...
      <div class="bottom">
        <div class="bottom-top">
            <div class="bottom-top-card">
                ...
                <button class="btn btn-signup"><a href="../property/regType.jsp">Sign Up Now</a></button>
            </div>
