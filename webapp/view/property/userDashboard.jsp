...
<head>
    <meta charset="UTF-8">
    <title>User Dashboard - PropertyPro</title>
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="navigation">
            ...
            <a href="../../ListServ?userId=<%=userId%>" class="nav-btn">
        ...
        <div class="dashboard-card">
            ...
            <div class="row">
                ...
                <input type="hidden" name="userId" value="<%=userId%>">
                    <a href="../payment/FormPay.jsp?userId=<%=userId%>" class="btn btn-accent w-100">
                        <i class="fas fa-search me-2"></i> Add Payment Method
                    </a>
                </div>
                 <div class="col-md-6 mb-2">
                <input type="hidden" name="userId" value="<%=userId%>">
                <input type="hidden" name="userName" value="<%=userName%>">
                    <a href="../../GetAllTenantServlet?userId=<%=userId%>" class="btn btn-accent w-100">
                        <i class="fas fa-search me-2"></i> Rented properties
                    </a>
                </div>
                
                 <div class="col-md-6 mb-2">
                <input type="hidden" name="userId" value="<%=userId%>">
                    <a href="../../PaymentGetAll?userId=<%=userId%>" class="btn btn-accent w-100">
                        <i class="fas fa-search me-2"></i> Payment Details
                    </a>
                </div>
