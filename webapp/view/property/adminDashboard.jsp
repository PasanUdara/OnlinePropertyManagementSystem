...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-card">
            <h4 class="card-title"><i class="fas fa-tasks"></i> Manage Details</h4>
               ...
               <div class="row">
                    ...
                    <a href="../../PayAll"  class="btn btn-accent w-100" >
				...
				<div class="col-md-6 mb-2" >
                    ...
                    <a href="../../ShowAll" class="btn btn-accent w-100" >
                        <i class="fas fa-search me-2"></i> Rent Details
                    </a>
                </div>
				...
				<div class="col-md-6 mb-2" >
                    ...
                    <a href="../../AllProperty"  class="btn btn-accent w-100" >
                ...
                <div class="col-md-6 mb-2" >
                    ...
                    <a href="../../GetAllServlet"  class="btn btn-accent w-100" >
                        <i class="fas fa-search me-2"></i> Lease Details
                    </a>
                </div>
